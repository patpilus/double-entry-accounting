    ...
    public function testAllowsToGetBalanceAtAnyTimeOfTheHistory(): void
    {
        ...
        $account->registerPayment(
            new Payment(
                ...
                $account->getId(),
                TransactionId::generate(),
                Amount::fromString('1315.22'),
                new DateTimeImmutable('2021-01-01 00:00:15')
            )
        );
        $account->registerPayment(
            new Payment(
                ...
                $account->getId(),
                TransactionId::generate(),
                Amount::fromString('9566.10'),
                new DateTimeImmutable('2021-01-01 00:01:12')
            )
        );
        $account->registerPayment(
            new Payment(
                ...
                $account->getId(),
                TransactionId::generate(),
                Amount::fromString('1001.03'),
                new DateTimeImmutable('2021-02-23')
            )
        );
